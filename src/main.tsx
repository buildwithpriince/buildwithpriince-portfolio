...
/* =========================================================
   HERO PORTRAIT — BOTTOM CORNER BLUR
   Robust version: uses duplicated image layers instead of
   relying on transparent backdrop-filter surfaces.
   ========================================================= */
...
.device-frame::after {
  ...
  background-image: url("/prince-portrait.jpg") !important;
